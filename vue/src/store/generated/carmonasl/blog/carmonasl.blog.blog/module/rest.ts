...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/carmonasl/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/carmonasl/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/carmonasl/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/carmonasl/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/carmonasl/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryPostsResponse, RpcStatus>({
      path: `/carmonasl/blog/blog/posts`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
