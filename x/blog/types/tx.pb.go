...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "carmonasl.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "carmonasl.blog.blog.MsgCreatePostResponse")
	proto.RegisterType((*MsgCreateComment)(nil), "carmonasl.blog.blog.MsgCreateComment")
	proto.RegisterType((*MsgCreateCommentResponse)(nil), "carmonasl.blog.blog.MsgCreateCommentResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4e, 0x4e, 0x2c, 0xca, 0xcd,
	0xcf, 0x4b, 0x2c, 0xce, 0xd1, 0x03, 0x49, 0x80, 0x09, 0xa5, 0x60, 0x2e, 0x5e, 0xdf, 0xe2, 0x74,
	...
	0x4c, 0x99, 0x29, 0x4a, 0x79, 0x5c, 0x02, 0x70, 0x85, 0xce, 0xf9, 0xb9, 0xb9, 0xa9, 0x79, 0xf8,
	0x1c, 0x20, 0xc6, 0xc5, 0x56, 0x90, 0x5f, 0x5c, 0xe2, 0xe9, 0x02, 0x76, 0x01, 0x4b, 0x10, 0x94,
	0x87, 0x70, 0x18, 0x33, 0x36, 0x87, 0xb1, 0x20, 0x39, 0x4c, 0x8a, 0x4b, 0x02, 0xdd, 0x3e, 0x98,
	0xdb, 0x8c, 0x4e, 0x31, 0x72, 0x31, 0xfb, 0x16, 0xa7, 0x0b, 0xc5, 0x70, 0x71, 0x21, 0x05, 0x87,
	0x92, 0x1e, 0x96, 0x50, 0xd3, 0x43, 0xf1, 0x9d, 0x94, 0x16, 0x61, 0x35, 0xf0, 0x10, 0x48, 0xe5,
	0xe2, 0x45, 0xf5, 0xae, 0x2a, 0x7e, 0xcd, 0x50, 0x65, 0x52, 0xba, 0x44, 0x29, 0x83, 0x59, 0xe3,
	...
	0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x70, 0x23, 0xf5, 0xc1, 0x29, 0xa5, 0x02, 0x42,
	0x95, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x13, 0x8d, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff,
	0x0f, 0xc2, 0x67, 0x28, 0x45, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/carmonasl.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateComment(ctx context.Context, in *MsgCreateComment, opts ...grpc.CallOption) (*MsgCreateCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/carmonasl.blog.blog.Msg/CreateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/carmonasl.blog.blog.Msg/CreatePost",
	}
...
func _Msg_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/carmonasl.blog.blog.Msg/CreateComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "carmonasl.blog.blog.Msg",
