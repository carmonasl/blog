...
func init() {
	...
	proto.RegisterType((*MsgDeleteComment)(nil), "carmonasl.blog.blog.MsgDeleteComment")
	proto.RegisterType((*MsgDeleteCommentResponse)(nil), "carmonasl.blog.blog.MsgDeleteCommentResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0x6c, 0xe0, 0xbc, 0x66, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x96, 0x25, 0x2c, 0x03, 0x7c, 0x03,
	0x00, 0x00,
}
...
func (c *msgClient) DeleteComment(ctx context.Context, in *MsgDeleteComment, opts ...grpc.CallOption) (*MsgDeleteCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/carmonasl.blog.blog.Msg/DeleteComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/carmonasl.blog.blog.Msg/DeleteComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
